...
<p className='page_heading' style={{color:"#fff"}}>Unlock Your Potential with JM Edu <br/>  Courses </p>
<p className='page_text'>Explore our diverse range of courses designed to ignite your curiosity and boost your career.</p>
    </wrapper>
